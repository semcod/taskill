...
def test_discover_providers_returns_builtins():
...
def test_build_chain_with_enabled_providers():
...
def test_build_chain_with_unknown_provider():
...
def test_build_chain_empty_config():
